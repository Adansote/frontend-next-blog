...
const PageCardStore = ({ book }: Props) => {
    ...
    return (
        <div className='bg-white border border-black rounded-lg shadow dark:bg-gray-800 dark:border-gray-700'>
            <Image
            ...
            <div className='p-5'>
                ...
                <p className='text-gray-700 mb-3 font-normal dark:text-gray-400'>
                    {description}
                </p>
                <button
                    className={cn(
